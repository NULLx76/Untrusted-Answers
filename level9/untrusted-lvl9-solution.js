...
map.defineObject('raft2', {
    ...
    map.placeObject(20, 6, 'raft2');
    map.placeObject(20, 7, 'raft2');
    map.placeObject(20, 8, 'raft2');
    map.placeObject(20, 9, 'raft2');
    map.placeObject(20, 10, 'raft2');
    map.placeObject(20, 11, 'raft2');
    map.placeObject(20, 12, 'raft2');
    map.placeObject(20, 13, 'raft2');
    map.placeObject(20, 14, 'raft2');
    map.placeObject(20, 15, 'raft2');
